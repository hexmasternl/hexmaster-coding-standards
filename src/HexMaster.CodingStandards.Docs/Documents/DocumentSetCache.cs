...
/// <summary>
/// Holds the current <see cref="DocumentSet"/> and swaps it atomically on refresh.
/// </summary>
/// <remarks>
/// The whole cache is one reference to an immutable set, so a refresh is a single volatile
